function Marker(data, map, infowindow){
    ...
    "<a target='_blank' href='http://maps.google.com/maps?q=&layer=c&cbll="+this.position.lat+","+this.position.long+"'>"+
    "<img src='https://maps.googleapis.com/maps/api/streetview?size=100x100&location="+this.position.lat+","+this.position.long+"' height='100' width='100'></a>"+
    "</div>"+
    "</div>";
